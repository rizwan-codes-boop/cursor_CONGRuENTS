...
//This populates the data object for the function F(x)
...
// Synchrotron energy loss rate in GeV/s
...
// Synchrotron energy loss rate per unit momentum in 1/s
