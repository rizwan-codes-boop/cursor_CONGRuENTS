...
double dsigma_BSdEgamm1__mbGeVm1( double E_gam__GeV, double E_e__GeV, gsl_spline_object_1D Phi_1H_gso1D, gsl_spline_object_1D Phi_2H_gso1D )
{
    double phi_1, phi_2;
    //Delta parameter
    //Dimensionless screening parameter that determines which regime we're in( whether atomic screening is important or not)
...
//Initialize the 2D lookup table for bremsstrahlung cross-section
...
//same as above but returns a data object instead
...
/*#########################################################################
THIS CODE IS RETAINED FOR REFERENCE BUT IS NOT USED IN THE CURRENT IMPLEMENTATION!
#########################################################################*/
/*
...
//Bremsstrahlung power emitted per electron per energy interval per cm^3 per s
...
//Full numerical integration for bremsstrahlung loss timescale
